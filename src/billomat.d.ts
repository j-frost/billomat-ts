import { BILLOMAT_RESOURCE_NAMES } from './billomat.api';

export type BillomatResourceName = typeof BILLOMAT_RESOURCE_NAMES[number];

export interface BillomatResource {
    id?: string;
}

export interface BillomatArticle extends BillomatResource {
    created?: string;
    updated?: string;
    archived?: string;
    unit_id?: string;
    ...
    'article-property-values'?: {
        'article-property-value': BillomatArticlePropertyValue | BillomatArticlePropertyValue[];
    };
}

export interface BillomatArticlePropertyValue extends BillomatResource {
    article_id: string;
...
export interface BillomatClient extends BillomatResource {
    created?: string;
    updated?: string;
    archived?: string;
    dig_exclude?: string;
    ...
    'client-property-values'?: {
        'client-property-value': BillomatClientPropertyValue | BillomatClientPropertyValue[];
    };
}

export interface BillomatClientPropertyValue extends BillomatResource {
    client_id: string;
...
export interface BillomatInvoice extends BillomatResource {
    created?: string;
    updated?: string;
    client_id?: string;
    contact_id?: string;
...
export interface BillomatInvoiceItem extends BillomatResource {
    article_id?: string;
    invoice_id?: string;
    position?: string;
    unit?: string;
